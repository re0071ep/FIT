...
plot \
"gnuplot1.csv" using 1:2 title "Experiment 1" with point ls 1 \
,"gnuplot2.csv" using 1:2 title "Experiment 2" with point ls 2 \
,"gnuplot3.csv" using 1:2 title "Experiment 3" with point ls 3 \
,"gnuplot4.csv" using 1:2 title "Experiment 4" with point ls 4 \
,"gnuplot5.csv" using 1:2 title "Experiment 5" with point ls 5 \
,"gnuplot6.csv" using 1:2 title "Experiment 6" with point ls 6 \
,"gnuplot7.csv" using 1:2 title "Experiment 7" with point ls 7 \
,"gnuplot8.csv" using 1:2 title "Experiment 8" with point ls 8 \
,"gnuplot9.csv" using 1:2 title "Experiment 9" with point ls 9 \
,"gnuplot10.csv" using 1:2 title "Experiment 10" with point ls 10 \
,"gnuplot1.csv" using 1:4 title "Fitting 1" with point ls 11 \
,"gnuplot2.csv" using 1:4 title "Fitting 2" with point ls 12 \
,"gnuplot3.csv" using 1:4 title "Fitting 3" with point ls 13 \
,"gnuplot4.csv" using 1:4 title "Fitting 4" with point ls 14 \
,"gnuplot5.csv" using 1:4 title "Fitting 5" with point ls 15 \
,"gnuplot6.csv" using 1:4 title "Fitting 6" with point ls 16 \
,"gnuplot7.csv" using 1:4 title "Fitting 7" with point ls 17 \
,"gnuplot8.csv" using 1:4 title "Fitting 8" with point ls 18 \
,"0nuplot9.csv" using 1:4 title "Fitting 9" with point ls 19 \
,"gnuplot10.csv" using 1:4 title "Fitting 10" with point ls 20